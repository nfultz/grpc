...
fetchWithMetadata <- function(server, method, requestArg, metadata) {
    .Call('_grpc_fetchWithMetadata', PACKAGE = 'grpc', server, method, requestArg, metadata)
}

fetch <- function(server, method, requestArg) {
