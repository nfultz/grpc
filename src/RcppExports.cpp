...
RcppExport SEXP _grpc_fetch(SEXP serverSEXP, SEXP methodSEXP, SEXP requestArgSEXP, SEXP metadataSEXP, SEXP timeoutSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fetch(server, method, requestArg, metadata, timeout));
