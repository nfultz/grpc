...
RcppExport SEXP _grpc_run(SEXP targetSEXP, SEXP hoststringSEXP, SEXP on_start_hookSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< Function >::type on_start_hook(on_start_hookSEXP);
    rcpp_result_gen = Rcpp::wrap(run(target, hoststring, on_start_hook));
    return rcpp_result_gen;
END_RCPP
}
